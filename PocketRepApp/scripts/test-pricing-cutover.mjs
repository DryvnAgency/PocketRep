...
inc('landing', landing, ['"price":"39.00"','<span class="now">$39</span>','Day 8 — $39/mo begins if the subscription is still active','Is PocketRep worth $39 a month?','$39/mo Founding Rep rate.','Founding rate · $39/mo while subscription stays active',CURRENT_URL,'7-day free trial','V1 · Know who to work','V2 · Know exactly what to do','V3 · Run your business','$39 <small>/mo · reps 1–500</small>','$59 <small>/mo · reps 501–1,000</small>','$79 <small>/mo · rep 1,001+</small>','Founding cohort: first 500 paying reps at $39/mo.','Reps 501–1,000 join at $59/mo and rep 1,001+ joins at $79/mo.','Native PocketRep apps for iPhone and Android','href="#try" aria-label="Jump to the interactive PocketRep demo"','Secure checkout by Stripe. By continuing you agree to our','/terms.html','/privacy.html','/cancel.html','service@pocketrep.pro']);
...
inc('decisions', decisions, ['**V1 Founding Rep: $39/month**','temporary $29 launch cutover is **retired**',`Current V1 price: \`${CURRENT_PRICE}\` — $39/month`,`Checkout URL: \`${CURRENT_URL}\``,'**Reps #501–1,000: $59/month**','**Rep #1,001+: $79/month**','**first ~500 paying reps = $39 → next ~500 = $59 → then $79**','Cutovers are owner-managed manually','A short burst of additional signups at the prior rate during a rush is acceptable','**RexLens is separate/out-of-scope from PocketRep.']);
