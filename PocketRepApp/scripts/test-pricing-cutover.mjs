...
inc('landing', landing, ['"price":"39.00"','<span class="now">$39</span>','Founding Rep access is $39/month','Day 8 — $39/mo begins if the subscription is still active','Is PocketRep worth $39 a month?','$39/mo Founding Rep rate.','Founding rate · $39/mo while subscription stays active',CURRENT_URL,'7-day free trial','V1 · Know who to work','V2 · Know exactly what to do','V3 · Run your business','$59 <small>planned new-customer rate','$79 <small>planned new-customer rate','Native PocketRep apps for iPhone and Android','href="#try" aria-label="Jump to the interactive PocketRep demo"']);
exc('landing', landing, [RETIRED_29_URL,'"price":"29.00"','<span class="now">$29</span>','Founding Rep access is $29/month','Day 8 — $29/mo begins','Is PocketRep worth $29 a month?','$29/mo Founding Rep rate.','Founding rate · $29/mo while subscription stays active','Next new-customer cohort: $54/mo after the first 500','First 500 paying reps','39 USD per month for the first 500','The first 500 paying reps get the $39 monthly founding rate','$39/mo founding rate for the first 500 paying reps','Founding rate · $39/mo locked forever','$49 <small>planned new-customer rate','$69 <small>planned new-customer rate','still here with your name on it','trade at the top of the range','charging + warranty are no contest','saved you the 540i','m340i in portimao is rare','want me to hold it while you decide']);
...
inc('decisions', decisions, ['**V1 Founding Rep: $39/month**','temporary $29 launch cutover is **retired**',`Current V1 price: \`${CURRENT_PRICE}\` — $39/month`,`Checkout URL: \`${CURRENT_URL}\``,'**V2 direction for new customers: $59/month**','**V3 direction for new customers: $79/month**','**$39 → $59 → $79**','**RexLens is separate/out-of-scope from PocketRep.']);
