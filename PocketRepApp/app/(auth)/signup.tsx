...
const PLANS: { id: Plan; name: string; price: string; after: string; features: string[] }[] = [
  {
    ...
    name: 'Pro',
    price: '$29',
    after: '$49/mo after Apr 15',
    features: [
      'Heat Sheet — top 5 ready-to-buy contacts',
      'AI Rebuttals (Rex Chat)',
      'Mass Text — up to 50 contacts',
  ...
  },
  {
    ...
    name: 'Elite',
    price: '$47',
    after: '$79/mo after Apr 15',
    features: [
      'Everything in Pro',
      'Mass Text — up to 100 contacts',
      'Rapport Vault + AI vision',
      'Rex Memory — personalized AI',
      'Map view + proximity alerts',
...
export default function SignupScreen() {
  ...
  async function handleSignup() {
    ...
    if (data.user) {
      await supabase.from('profiles').update({ full_name: name, plan }).eq('id', data.user.id);
    }
  ...
  return (
    <KeyboardAvoidingView style={s.root} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
        ...
        <Text style={s.sub}>7 days free. Card required. Cancel before day 8 — zero charge.</Text>
        ...
        <View style={s.form}>
          ...
          <Text style={s.micro}>
            Card required to start. You won't be charged until day 8. Cancel anytime before then.
          </Text>
        </View>
      </ScrollView>
