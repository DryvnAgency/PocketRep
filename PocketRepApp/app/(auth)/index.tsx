...
const s=StyleSheet.create({root:{flex:1,backgroundColor:colors.ink},scrollBg:{backgroundColor:colors.ink},scroll:{flexGrow:1,justifyContent:'center',padding:spacing.xl,backgroundColor:colors.ink},logoWrap:{flexDirection:'row',alignItems:'center',gap:10,marginBottom:spacing.xxl},logoMark:{width:38,height:38,borderRadius:radius.sm,backgroundColor:colors.gold,alignItems:'center',justifyContent:'center'},logoMarkText:{color:colors.ink,fontWeight:'800',fontSize:18},logoText:{fontSize:22,fontWeight:'700',color:colors.white,letterSpacing:-.5},headline:{fontSize:28,fontWeight:'800',color:colors.white,letterSpacing:-.5,marginBottom:6},sub:{fontSize:15,color:colors.grey2,marginBottom:spacing.xxl},form:{gap:spacing.sm},label:{fontSize:12,fontWeight:'600',color:colors.grey3,letterSpacing:.5,textTransform:'uppercase',marginTop:spacing.sm},input:{backgroundColor:colors.surface2,borderWidth:1,borderColor:colors.ink4,borderRadius:radius.sm,padding:spacing.md,color:colors.white,fontSize:15},btn:{backgroundColor:colors.gold,borderRadius:radius.sm,padding:spacing.md+2,alignItems:'center',marginTop:spacing.md},btnText:{color:colors.ink,fontWeight:'700',fontSize:15},forgot:{alignItems:'center',paddingVertical:10},forgotText:{color:colors.gold,fontWeight:'600',fontSize:13},footer:{flexDirection:'row',justifyContent:'center',marginTop:spacing.xl},footerText:{color:colors.grey2,fontSize:14},footerLink:{color:colors.gold,fontWeight:'600',fontSize:14},siteLink:{alignItems:'center',marginTop:spacing.lg,paddingVertical:8},siteLinkText:{color:colors.grey,fontSize:13,backgroundColor:colors.surface2,paddingHorizontal:14,paddingVertical:6,borderRadius:radius.full}});
