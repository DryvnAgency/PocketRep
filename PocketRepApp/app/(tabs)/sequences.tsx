...
const TEMPLATES: Sequence[] = [
  // ── AUTO ─────────────────────────────────────────────────────────────────
  {
    ...
    sequence_steps: [
      ...
      { id: 's3', sequence_id: 'tpl_1', step_number: 3, delay_days: 21, channel: 'call', message_template: '21-day check-in call. Focus entirely on their experience — how is the vehicle performing, any service questions, anything they need help with. The goal is making sure they\'re genuinely taken care of. Don\'t ask for anything.', ai_personalize: false },
  ...
  },
  {
    ...
    sequence_steps: [
      ...
      { id: 't4s6', sequence_id: 'tpl_4', step_number: 6, delay_days: 30, channel: 'text', message_template: 'Hey {{first_name}}, one month in! 🎉 How is the {{vehicle}} treating you? Anything come up I can help with — service, features, anything at all? I\'m still your rep, not just the person who handed you the keys.', ai_personalize: false },
      { id: 't4s7', sequence_id: 'tpl_4', step_number: 7, delay_days: 90, channel: 'text', message_template: 'Hey {{first_name}}, 3 months with the {{vehicle}} already — time flies. Hope every drive has been a good one. If anything ever comes up — service, questions, whatever — just reach out. Always here.', ai_personalize: false },
  ...
  },
  {
    ...
    sequence_steps: [
      ...
      { id: 't5s7', sequence_id: 'tpl_5', step_number: 7, delay_days: 180, channel: 'text', message_template: 'Hey {{first_name}}, 6 months in! Your equity is building and you\'re in a great spot. If rates ever shift in your favor I\'ll be the first to tell you. And if anyone you know is going through a home purchase or refi and wants someone who actually explains what\'s happening, happy to be that for them too.', ai_personalize: false },
  ...
  // ── PROSPECT NURTURE ─────────────────────────────────────────────────────
  {
    ...
    sequence_steps: [
      ...
      { id: 't8s3', sequence_id: 'tpl_8', step_number: 3, delay_days: 2, channel: 'text', message_template: 'Hey {{first_name}}, thought I\'d share something that might be useful as you think things through — [drop a relevant tip, comparison, or piece of info that helps them, not sells them]. No strings, just want to be a good resource.', ai_personalize: false },
      { id: 't8s4', sequence_id: 'tpl_8', step_number: 4, delay_days: 3, channel: 'text', message_template: 'Hey {{first_name}}, if you have any questions or things you\'re trying to figure out, I\'m here for that. No pitch — just answers. What\'s on your mind?', ai_personalize: false },
      { id: 't8s5', sequence_id: 'tpl_8', step_number: 5, delay_days: 5, channel: 'text', message_template: 'Hey {{first_name}}, just checking back in. Happy to run any numbers, answer anything, or just be a sounding board while you\'re weighing your options. No rush on my end at all.', ai_personalize: false },
  ...
  // ── DOOR-TO-DOOR ─────────────────────────────────────────────────────────
  {
    ...
    sequence_steps: [
      ...
      { id: 't10s3', sequence_id: 'tpl_10', step_number: 3, delay_days: 5, channel: 'text', message_template: 'Hey {{first_name}}, just wanted to make sure you had a full picture of what the service actually looks like day-to-day before I close out the area. Happy to answer any questions — what it covers, what the experience is like, anything. No commitment, just information.', ai_personalize: false },
      ...
      { id: 't10s5', sequence_id: 'tpl_10', step_number: 5, delay_days: 21, channel: 'text', message_template: 'Hey {{first_name}}, it\'s been a few weeks — hope things are good on your end. Didn\'t want to disappear without leaving the door open. If you ever want to revisit the conversation or have questions, I\'m still around. No pressure either way.', ai_personalize: false },
    ],
  },
  // ── ROOFING ──────────────────────────────────────────────────────────────
  {
