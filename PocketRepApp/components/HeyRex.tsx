...
//   4. Rex (Gemini) parses it into: contact match, notes, follow-up date, game plan
...
`.trim();
      ...
      const rr = await fetch(`${AI_PROXY_URL}/gemini`, {
        method: 'POST',
        headers: {
...
`.trim();
    ...
    const r = await fetch(`${AI_PROXY_URL}/gemini`, {
      method: 'POST',
      headers: { 'content-type': 'application/json' },
      body: JSON.stringify({
        model: REX_MODEL,
