  ...
  return (
    <View style={styles.root}>
            ...
            <View style={styles.form}>
              ...
              <View style={styles.industryWrap}>
                {INDUSTRIES.map(industry => (
                  <Pressable key={industry} onPress={() => setAnswers(a => ({ ...a, industry }))} style={[styles.industryChip, answers.industry === industry && styles.industryChipSelected]}>
        ...
        {step === 2 ? (
          <>
            ...
            {demoReplyVisible && replyContact ? (
              <Animated.View style={[styles.replyToast, { opacity: replyAnim, transform: [{ translateY: replyAnim.interpolate({ inputRange: [0, 1], outputRange: [-18, 0] }) }] }]}>
      ...
      <View style={styles.bottom}>
        {step === 0 ? (
          <Pressable onPress={() => { void saveIdentity().then(ok => { if (ok) setStep(1); }); }} disabled={saving} style={[styles.primary, saving && styles.disabled]}>
