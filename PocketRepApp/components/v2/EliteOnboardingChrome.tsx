...
const styles = StyleSheet.create({
  ...
  progressRow: { width: '100%', minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: 14 },
  ...
  skipButton: { minHeight: 44, minWidth: 44, flexShrink: 0, alignItems: 'flex-end', justifyContent: 'center', paddingHorizontal: 4 },
  skipText: { color: colors.grey2, fontSize: 12, fontWeight: '700', letterSpacing: 0.5, textAlign: 'right' },
  rexRow: { minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: 12 },
  rexOrb: { width: 42, height: 42, flexShrink: 0, borderRadius: 21, borderWidth: 1, borderColor: colors.goldBorderStrong, backgroundColor: colors.ink2, alignItems: 'center', justifyContent: 'center' },
  rexCore: { width: 12, height: 12, borderRadius: 6, backgroundColor: colors.gold },
  rexCopy: { flex: 1, minWidth: 0 },
  ...
  heading: { width: '100%', minWidth: 0, gap: 8 },
  eyebrow: { color: colors.grey2, fontSize: 10, fontWeight: '800', letterSpacing: 1.2, textTransform: 'uppercase' },
  title: { flexShrink: 1, color: colors.white, fontSize: 30, lineHeight: 34, fontWeight: '800', letterSpacing: -0.7 },
  body: { flexShrink: 1, color: colors.grey3, fontSize: 14, lineHeight: 21 },
  panel: { width: '100%', minWidth: 0, backgroundColor: colors.surface, borderColor: colors.ink4, borderWidth: 1, borderRadius: radius.xl, padding: 18 },
  panelCompact: { padding: 14 },
  choice: { width: '100%', minWidth: 0, minHeight: 48, justifyContent: 'center', borderWidth: 1, borderColor: colors.ink4, borderRadius: radius.md, backgroundColor: colors.surface2, paddingHorizontal: 14, paddingVertical: 10 },
  ...
  choiceDetail: { flexShrink: 1, color: colors.grey2, fontSize: 10, lineHeight: 14, marginTop: 3 },
  quickReply: { minHeight: 44, minWidth: 0, flexGrow: 1, flexBasis: 144, maxWidth: '100%', justifyContent: 'center', borderWidth: 1, borderColor: colors.ink4, borderRadius: radius.full, backgroundColor: colors.surface2, paddingHorizontal: 14, paddingVertical: 8 },
  quickReplySelected: { borderColor: colors.goldBorderStrong, backgroundColor: colors.goldBg },
  quickReplyContent: { minWidth: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  ...
  loadingActionRow: { maxWidth: '100%', minWidth: 0, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 },
  actionText: { maxWidth: '100%', flexShrink: 1, textAlign: 'center', fontSize: 13, lineHeight: 17, fontWeight: '900', letterSpacing: 0.9 },
